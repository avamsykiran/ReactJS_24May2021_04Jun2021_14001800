...
public class TxnController {
	...
	@PutMapping("/{txnId}")
	public ResponseEntity<TranModel> saveTransaction(@PathVariable("txnId")long txnId,@RequestBody @Valid TranModel tran,BindingResult valiResult) throws InvalidTxnDetailsException {
